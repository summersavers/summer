...
func (*IntroScene) Setup(u engo.Updater) {
	...
	w.AddSystemInterface(&systems.PlayerSelectSystem{}, playerselectable, notplayerselectable)
	...
	griffA.Drawable, _ = common.LoadedSprite(files[12])
	...
	griffB.Drawable, _ = common.LoadedSprite(files[15])
	...
	griffX.Drawable, _ = common.LoadedSprite(files[13])
	...
	griffY.Drawable, _ = common.LoadedSprite(files[14])
